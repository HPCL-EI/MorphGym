...
def run_joint_monkey(asset_root, file_list, moving=True, fix_root=True, gravity=True):
    # parse arguments
    ...
    print(f"Loading {len(file_list)} asset")
...
if __name__ == '__main__':
    asset_root = f'/home/cxl/aworkspace/codes/morphgym/morphgym/agents/unimal/output/xml/'
    file_list = [f'8854c1a46c368a8aed593cb4aa9c18bf.xml']
    run_joint_monkey(asset_root, file_list, moving=True, fix_root=True, gravity=False)
