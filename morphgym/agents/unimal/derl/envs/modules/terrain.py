...
class Terrain:
    ...
    def create_corridor(self):
        ...
        # sampled obstacle from the list config.TERRAIN.TYPES
    ...
    def create_scene(self):
        ...
        # Pad hfield with config.HFIELD.GAP_DEPTH to handle hfield obs when
        # agent is at edges
    ...
    def assert_cfg(self):
        # We make quite a few assumptions in the code. Check here if config
