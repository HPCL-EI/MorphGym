...
# hardcoded in make_env_task func. Put wrappers which you want to run
# with.
_C.ENV.WRAPPERS = []
# ----------------------------------------------------------------------------#
# Terrain Options
...
# ----------------------------------------------------------------------------#
# Output directory
_C.OUT_DIR = os.path.join(os.path.dirname(__file__),"../output")
...
_C.UNIMAL_TEMPLATE = os.path.join(os.path.dirname(__file__),"envs/assets/unimal.xml")
