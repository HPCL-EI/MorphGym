...
class RaptorFSM(BaseFSM):
    ...
    #     self.contact_indicate_buf[:,0] = self.contact_left_tensor[:, 2] > self.config.contact_threshold
    #     self.contact_indicate_buf[:,1] = self.contact_right_tensor[:, 2] > self.config.contact_threshold
    #
