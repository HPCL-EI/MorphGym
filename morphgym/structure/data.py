...
from dataclasses import  _set_new_attribute,_get_field,Field,MISSING,_FIELDS,_POST_INIT_NAME,_FIELD,_FIELD_INITVAR,_init_fn,_PARAMS,_DataclassParams,_repr_fn,_tuple_str,_cmp_fn,_frozen_get_del_attr,_hash_action
import inspect
import sys
import traceback
...
def data(cls=None, /, *, eq=True, order=False,
